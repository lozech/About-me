...
const data3 = [
    [
        ...
        "JS/Swiper.js/GSAP/HTML5/CSS3","메인(전 페이지 구현)", "모어비전은 래퍼 박재범이 장르 문화를 기반으로 설립한 새로운 엔터테인먼트 허브입니다. 처음으로 swiper.js와 gsap을 활용하여 사이트 전체를 리뉴얼 해보았습니다."
    ],
    [
        2, "EMET SOUND","./images/emet2.png", null, "https://lozech.github.io/emet-sound/",
        "REACT/JS/GSAP/HTML5/CSS3","전체 페이지", "에메트사운드 레이블은 장르의 경계를 허물고 '에메트스러움'을 음악으로 치환하는 사운드 프로듀싱 허브입니다. 리액트 라이브러리를 사용하여 진행한 프로젝트로서 사이트 구현에 있어서 속도를 높이고자 하였습니다. 링크 간의 이동이 자연스럽고, 컴포넌트 활용이 자유로운 리액트를 통해 하나의 사이트를 더욱 더 효과적으로 완성할 수 있었습니다."],
    [
        3, "Beyond Sangsang", "./images/beyond2.png", null, "https://lozech.github.io/Beyond-Sangsang/",
        "REACT/JS/HTML5/CSS3","전체 페이지", "비욘드상상은 작가와 프로듀서진들로 구성된 광고 제작사입니다. 리액트로 진행한 두번째 프로젝트로서 해당 브랜드에서 추구하는 시선을 끄는 그림을 만드는 이야기에 매력을 느끼고 프로젝트 대상으로 선정하였습니다. 기존 사이트에서 사진과 영상이 로딩이 느린 점을 개선하며 완성도를 높였습니다. 애니메이션 효과를 심층적으로 활용하여 동적인 요소들을 확장하고자 했습니다."],
    [4, "Blackpaper", "./images/blackpaper.png", null, "https://lozech.github.io/blackpaper/",
        "REACT/JS/HTML5/CSS3","전체 페이지", "블랙페이퍼는 방송인 유병재 등이 설립한 크리에이티브 아티스트 매니지먼트사입니다. 리액트로 구현한 세번째 프로젝트로서 블랙페이퍼만의 색깔을 담기 위해 테마별 파비콘을 지정하고 블랙모드/화이트 모드 토글도 제작해보았습니다. 기존 사이트 내 미비한 링크 부분도 보충하여 보다 완성도 있는 리뉴얼을 진행해보았습니다."],
];
